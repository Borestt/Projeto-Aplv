  ...
  return (
    <>
      ...
      <div className="infos-container">
        <h1>Página de Informação</h1>
        <p>
          Bem-vindo ao nosso mundo de RPG online, um universo onde estratégia, imaginação e aventura se encontram!
        </p>
        <p>
          Aqui, você cria o seu próprio personagem e escolhe entre diversas classes como Guerreiro, Mago e Guardião.
        </p>
        <p>
          Embarque em batalhas épicas contra criaturas sombrias que ameaçam a paz do reino. Enfrente monstros lendários
          e chefes inimigos colossais que exigem coragem para serem derrotados.
        </p>
